...
Site: https://morning-verlu.github.io/KAI/
GIF: https://morning-verlu.github.io/KAI/assets/kaios-demo.gif
Release ZIP: https://github.com/morning-verlu/KAI/releases/download/v0.1.82/kaios-0.1.82.zip
...
```bash
curl -L -o kaios-0.1.82.zip https://github.com/morning-verlu/KAI/releases/download/v0.1.82/kaios-0.1.82.zip
unzip kaios-0.1.82.zip
./kaios-0.1.82/bin/kaios quickstart
./kaios-0.1.82/bin/kaios run --index . --context README.md --out artifacts/project.md --trace-out artifacts/trace.json --force "summarize this project"
./kaios-0.1.82/bin/kaios gate --baseline artifacts/baseline.capsule.json --check
```
