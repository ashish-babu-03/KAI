...
Site: https://morning-verlu.github.io/KAI/
GIF: https://morning-verlu.github.io/KAI/assets/kaios-demo.gif
Release ZIP: https://github.com/morning-verlu/KAI/releases/download/v0.1.63/kaios-0.1.63.zip
...
```bash
curl -L -o kaios-0.1.63.zip https://github.com/morning-verlu/KAI/releases/download/v0.1.63/kaios-0.1.63.zip
unzip kaios-0.1.63.zip
./kaios-0.1.63/bin/kaios demo
./kaios-0.1.63/bin/kaios setup --ci
./kaios-0.1.63/bin/kaios verify --evidence --force
./kaios-0.1.63/bin/kaios run --index . --context README.md --out artifacts/project.md --trace-out artifacts/trace.json --force "summarize this project"
./kaios-0.1.63/bin/kaios verify --evidence --baseline artifacts/baseline.capsule.json --check --force
```
